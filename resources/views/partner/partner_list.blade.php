                    ...
                    <div class="card card-docs mb-2">
                        <div class="p-10">
                            ...
                            <h1 class="anchor fw-bolder mb-5" id="zero-configuration">
                                <a href="javascript:;"></a>Partner List
                            </h1>
                            ...
                            <div class="d-flex align-items-center rounded py-5 px-4 bg-light-primary">
                                ...
                                <!--end::Icon-->
                                <!--begin::Description-->
                                <div class="text-gray-700 fw-bold fs-6 lh-lg">Here we have a list of all of the Partner List that we have.</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Notice-->
                            <!--end::Heading-->
                            ...
                            <div class="py-5">
                                <table class="kt_datatable_example_1 table table-row-bordered gy-5">
                                    ...
                                    <tbody class="fw-bold text-gray-600">
                                        @for ($i = 0; $i < count($partnerList); $i++) @php $a=$i; $a++; @endphp 
                                        <tr>
                                            <td>{{$a}}</td>
                                            <td>{{date('Y-m-d',strtotime($partnerList[$i]->created_at))}}</td>
                                            <td>{{ucwords($partnerList[$i]->status)}}</td>
                                            <td>{{ucwords($partnerList[$i]->first_name)}}</td>
                                            <td>{{ucwords($partnerList[$i]->last_name)}}</td>
                                            <td>{{$partnerList[$i]->mobile_no}}</td>
                                            <td>{{$partnerList[$i]->email}}</td>
                                            <td>
                                                @php $path = $partnerList[$i]->path != '' ? asset($partnerList[$i]->path) : '#' @endphp
                                                <center>
                                                    <a href="{{$path}}" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary" data-bs-toggle="tooltip" data-bs-original-title="View Resume">
                                            ...
                                            <td>{{$partnerList[$i]->description}}</td>
                                            <td>
                                                <!-- <a href="#kt_modal_edit_admins" class="btn btn-icon btn-sm btn-color-gray-400 btn-active-icon-primary me-2" data-bs-toggle="modal" data-bs-original-title="Edit Partner">
                                                    <span class="svg-icon svg-icon-2">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
